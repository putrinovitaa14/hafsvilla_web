...
class PemesananController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $cek_pemesanans = Pemesanan::where('villa_id', $request->villa_id)->whereBetween('tanggal_keluar', [$request->tanggal_masuk, $request->tanggal_keluar])->get();
        // if (!empty($cek_pemesanans)) {
        //     return 'hello';
        // } else {
